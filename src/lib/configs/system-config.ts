...
export class SystemConfig {
    ...
    constructor(options?: any) {
        const { requestLog, tmpDir, logDir, logWriteInterval, logFileExpires, tmpFileExpires, requestBody, debug, log_level, dataDir, adminApiKey } = options || {};
        ...
        this.dataDir = _.defaultTo(dataDir, './data');
        this.adminApiKey = _.defaultTo(adminApiKey, process.env.ADMIN_API_KEY || '');
    }
